...
This project implements the backend for an Doctor appointment using Node.js, Express.js, and MongoDB. It provides APIs for user registration, authentication, Doctor management, and booking functionalities.
